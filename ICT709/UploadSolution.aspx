<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="UploadSolution.aspx.cs" Inherits="UploadSolution" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="form-horizontal">
        ...
        <asp:ValidationSummary runat="server" CssClass="text-danger" />
         ...
         <div class="form-group">
            <asp:Label runat="server" ID="Document" CssClass="col-md-2 control-label">Word Document Or PDF Or Rar.</asp:Label>
            <div class="col-md-10">
